	...
	<div>
		...
		<nav class="sidebar-nav scroll-sidebar" data-simplebar>
			<ul id="sidebarnav">
				...
				<li class="sidebar-item {{ Route::is('admin-panel.user.*') || Route::is('admin-panel.criteria.*') ? 'selected' : '' }}">
					...
					<ul aria-expanded="false" class="collapse first-level {{ Route::is('admin-panel.user.*') || Route::is('admin-panel.criteria.*') ? 'in' : '' }}">
			...
			<div class="unlimited-access hide-menu bg-light-primary position-relative my-7 rounded">
				<div class="d-flex">
					...
					<div class="unlimited-access-img">
						<img src="../../dist/images/backgrounds/rocket.png" alt=""
							class="img-fluid">
					</div>
				</div>
			</div>
