                        ...
                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up"
                            ...
                            <div class="message-body" data-simplebar>
                                <a href="javascript:void(0)"
                                    ...
                                    <span class="me-3">
                                        <img src="{{ asset('panel-assets/dist/images/profile/user-1.jpg') }}" alt="user"
                                ...
                                <a href="javascript:void(0)"
                                    class="py-6 px-7 d-flex align-items-center dropdown-item">
                                    <span class="me-3">
                                        <img src="{{ asset('panel-assets/dist/images/profile/user-2.jpg') }}" alt="user"
                                            class="rounded-circle" width="48" height="48" />
                                    </span>
                                    <div class="w-75 d-inline-block v-middle">
                                ...
                                <a href="javascript:void(0)"
                                    class="py-6 px-7 d-flex align-items-center dropdown-item">
                                    <span class="me-3">
                                        <img src="{{ asset('panel-assets/dist/images/profile/user-3.jpg') }}" alt="user"
                                            class="rounded-circle" width="48" height="48" />
                                    </span>
                                    <div class="w-75 d-inline-block v-middle">
                                ...
                                <a href="javascript:void(0)"
                                    class="py-6 px-7 d-flex align-items-center dropdown-item">
                                    <span class="me-3">
                                        <img src="{{ asset('panel-assets/dist/images/profile/user-4.jpg') }}" alt="user"
                                            class="rounded-circle" width="48" height="48" />
                                    </span>
                                    <div class="w-75 d-inline-block v-middle">
                                ...
                                <a href="javascript:void(0)"
                                    class="py-6 px-7 d-flex align-items-center dropdown-item">
                                    <span class="me-3">
                                        <img src="{{ asset('panel-assets/dist/images/profile/user-5.jpg') }}" alt="user"
                                            class="rounded-circle" width="48" height="48" />
                                    </span>
                                    <div class="w-75 d-inline-block v-middle">
                        ...
                        <a class="nav-link pe-0" href="javascript:void(0)" id="drop1"
                            ...
                            <div class="d-flex align-items-center">
                                <div class="user-profile-img">
                                    <img src="{{ asset('panel-assets/dist/images/profile/user-1.jpg') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <h5 class="fs-4 mb-3 w-50 fw-semibold text-dark">Unlimited
                                                    Access</h5>
                                                <button
                                                    class="btn btn-primary text-white">Upgrade</button>
                                            </div>
                                            <div class="col-6">
                                                <div class="m-n4">
                                                    <img src="{{ asset('panel-assets/dist/images/backgrounds/unlimited-bg.png') }}"
                                                        alt="" class="w-100">
                                                </div>
                                            </div>
                                        </div>
