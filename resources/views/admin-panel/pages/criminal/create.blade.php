...
@section('title', 'Tambah Data Pelaku Tindak Pidana')
        ...
        <div class="card bg-light-secondary shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Tambah Data Pelaku Tindak Pidana</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">Tambah Data Pelaku Tindak Pidana</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-warning">
                        <h4 class="mb-0 text-white card-title">Masukkan Data PTP Disini</h4>
                    </div>
                    <div class="card-body">
                        @if (count($errors) > 0)
                        ...
                        @endif
                        <form method="POST" action="{{ route('admin-panel.criminal.store') }}">
                            @csrf
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="criteria_id" id="criteria_id" class="select2 form-control" style="width: 100%; height: 36px">
									<option value="" selected hidden>--- Pilih Kriteria Tindak Pidana ---</option>
